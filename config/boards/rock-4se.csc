...
BL32_BLOB="rk33/rk3399_bl32_v2.12.bin"
DDR_BLOB="rk33/rk3399_ddr_933MHz_v1.30.bin"

function post_family_config___mainline_uboot() {
	declare -g UBOOT_TARGET_MAP="ROCKCHIP_TPL=${RKBIN_DIR}/${DDR_BLOB} BL32=$RKBIN_DIR/$BL32_BLOB spl/u-boot-spl u-boot.bin flash.bin;;idbloader.img u-boot.itb"
}
